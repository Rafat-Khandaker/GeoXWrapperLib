...
namespace GeoXWrapperLib.Model
{
    public class Wa2F3 : WA
    {
        ...
        private SegSide m_left_side;
        private SegSide m_right_side;

        // Constructor for Wa2F3
        public Wa2F3()
        {
            ...
            m_left_side = new SegSide();
            m_right_side = new SegSide();
        }

        // Constructor for Wa2F3 with a string input
        public Wa2F3(string inString) : this()
        {
            Wa2F3FromString(inString);
        }

        // Clear reinitializes the Wa2F3 object to spaces
        public override void Clear()
        {
            Wa2F3FromString(new string(' ', 450));
        }

        // ToString converts a Wa2F3 object to a string
        public override string ToString()
        {
            return Wa2F3ToString();
        }

        // FromString converts a string to a Wa2F3 object
        ...
        // Private methods
        public void Wa2F3FromString(string inString)
        {
            int i;
            ...
            // New 3-byte PGB_Flag; Shorten m_filler04 by 3 bytes
        ...
        public override string Print()
        {
            ...
            // Enhanced presentation of SegSide data
        ...
        public string Report()
        {
            ...
            // SPO(2022-05-31): New 3-byte PGB_Flag; Shorten m_filler04 by 3 bytes
            sb.AppendFormat("pgb_flag = {0}{1}", m_pgb_flag, Environment.NewLine);
            ...
            // sb.AppendLine(); // Unused sections, commented out for now.
            ...
            sb.AppendLine("*********************************************");
            sb.AppendLine("RIGHT SIDE");
            sb.AppendLine("*********************************************");
            sb.AppendLine(m_right_side.Print());
            sb.AppendLine("*********************************************");
